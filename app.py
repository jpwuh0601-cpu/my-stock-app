...
def get_data_cached(ticker_val):
    # 確保參數正確傳遞
    clean_ticker = ticker_val if (ticker_val.endswith(".TW") or ticker_val.endswith(".TWO")) else f"{ticker_val}.TW"
    try:
